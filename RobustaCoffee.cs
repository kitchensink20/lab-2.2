...
namespace Task2
{
    ...
    {
        public RobustaCoffee(double pricePerKilo, string physicalCondition, double weight)
        {
        ...
        {
            Console.WriteLine($"Кава робуста {PhysicalCondition}, цiна за кiло - {PricePerKilo}$, цiна з упаковкою - {FullPrice}$, вага - {Weight}кг");
        }
    }
}
